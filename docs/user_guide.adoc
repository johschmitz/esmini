...
See https://github.com/esmini/esmini/issues/63#issuecomment-742273326[issue 63] for brief information information on how to create vehicle models with moving wheels.
